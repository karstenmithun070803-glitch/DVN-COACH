            ...
            {filteredJobs.map((job) => (
              ...
              >
                ...
                <button
                  ...
                  className="absolute top-4 right-4 p-2 text-slate-300 hover:text-rose-500 bg-white hover:bg-rose-50 rounded-xl transition-all opacity-100 lg:opacity-0 lg:group-hover:opacity-100 z-10 border border-slate-100"
                >
